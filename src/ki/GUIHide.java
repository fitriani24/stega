...
public class GUIHide extends javax.swing.JFrame {
    ...
    private void proccessButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proccessButtonActionPerformed
        ...
        boolean ispng = coverMediaTextField.getText().contains(".png");
        ...
        if (isCoverMedia && isSecretMessage && ispng) {
    ...
    private static class CoverMedia {

        public CoverMedia() {
        }

        private CoverMedia(String text) {
